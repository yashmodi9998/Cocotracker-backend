...
const userSchema = new mongoose.Schema({
  ...
  phoneNumber: { type: String, required: true }, // Phone number of the user (required)
  password: { type: String, required: true }, // Password for user authentication (required)
  role: { type: String, enum: ["admin", "kiosk owner"], required: true }, // Role of the user (admin/kiosk owner) (required)
});
